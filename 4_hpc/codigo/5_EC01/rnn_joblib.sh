...
N_SAMPLES_VALUES=(40000)

NUM_J=${#JOBS_VALUES[@]}
NUM_S=${#N_SAMPLES_VALUES[@]}
TOTAL_COMBOS=$(( NUM_J * NUM_S ))
...
PYTHON_SCRIPT_PATH="${SLURM_SUBMIT_DIR}/rnn_joblib.py"
...
srun python3 "${PYTHON_SCRIPT_PATH}" train \
  --n-samples "${N_SAMPLES}" --n-features 64 --classes 4 \
